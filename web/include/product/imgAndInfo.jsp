    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="productNumber">
            ...
            <span>
				...
				<span class="arrow">
					<a class="increaseNumber" style="cursor: pointer;">
                        <span class="updown">
					...
					<a class="decreaseNumber" style="cursor: pointer;">
                        <span class="updown">
        ...
        <div class="buyDiv">
            ...
            <a style="cursor: pointer;" class="addCartLink"><button class="addCartButton"><span class="glyphicon glyphicon-shopping-cart"></span>加入购物车</button></a>
        </div>
    </div>
